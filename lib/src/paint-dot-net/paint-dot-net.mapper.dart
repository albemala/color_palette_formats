...
class PaintDotNetPaletteColorMapper
  ...
  static PaintDotNetPaletteColorMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = PaintDotNetPaletteColorMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<PaintDotNetPaletteColor, int> _f$green = Field(
    'green',
    _$green,
  );
  static int _$blue(PaintDotNetPaletteColor v) => v.blue;
  static const Field<PaintDotNetPaletteColor, int> _f$blue = Field(
    'blue',
    _$blue,
  );
  static int _$alpha(PaintDotNetPaletteColor v) => v.alpha;
  static const Field<PaintDotNetPaletteColor, int> _f$alpha = Field(
    'alpha',
    _$alpha,
  );
...
mixin PaintDotNetPaletteColorMappable {
  ...
  PaintDotNetPaletteColorCopyWith<
  ...
  @override
  String toString() {
    return PaintDotNetPaletteColorMapper.ensureInitialized().stringifyValue(
      this as PaintDotNetPaletteColor,
    );
  }

  @override
  bool operator ==(Object other) {
    return PaintDotNetPaletteColorMapper.ensureInitialized().equalsValue(
      this as PaintDotNetPaletteColor,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PaintDotNetPaletteColorMapper.ensureInitialized().hashValue(
      this as PaintDotNetPaletteColor,
    );
  }
}
...
extension PaintDotNetPaletteColorValueCopy<$R, $Out>
  ...
  get $asPaintDotNetPaletteColor => $base.as(
    (v, t, t2) => _PaintDotNetPaletteColorCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _PaintDotNetPaletteColorCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({int? red, int? green, int? blue, int? alpha}) => $apply(
    FieldCopyWithData({
      if (red != null) #red: red,
...
class PaintDotNetPaletteMapper extends ClassMapperBase<PaintDotNetPalette> {
  ...
  @override
  final MappableFields<PaintDotNetPalette> fields = const {#colors: _f$colors};
...
mixin PaintDotNetPaletteMappable {
  ...
  PaintDotNetPaletteCopyWith<
    PaintDotNetPalette,
    PaintDotNetPalette,
    PaintDotNetPalette
  >
  get copyWith =>
      _PaintDotNetPaletteCopyWithImpl<PaintDotNetPalette, PaintDotNetPalette>(
        this as PaintDotNetPalette,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PaintDotNetPaletteMapper.ensureInitialized().stringifyValue(
      this as PaintDotNetPalette,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return PaintDotNetPaletteMapper.ensureInitialized().equalsValue(
      this as PaintDotNetPalette,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PaintDotNetPaletteMapper.ensureInitialized().hashValue(
      this as PaintDotNetPalette,
    );
  }
}
...
abstract class PaintDotNetPaletteCopyWith<
  $R,
  $In extends PaintDotNetPalette,
  $Out
>
    implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<
