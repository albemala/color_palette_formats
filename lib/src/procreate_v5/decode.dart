...
// Note: This function now returns a single palette, assuming the .swatches
// file contains only one palette definition, matching the JSON structure
// provided earlier.
ProcreateV5Palette _decode(List<int> bytes) {
  ...
  if (archive.isEmpty || archive.first.isFile == false) {
    throw const FormatException(
      'Invalid Procreate v5 file: Expected a zip archive with at '
      'least one file.',
    );
  }
  ...
  // Use the generated mapper to convert the map into a
  // ProcreateV5Palette object
