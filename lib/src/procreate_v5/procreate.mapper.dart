...
mixin ProcreateV5SwatchMappable {
  ...
  ProcreateV5SwatchCopyWith<ProcreateV5Swatch, ProcreateV5Swatch,
          ProcreateV5Swatch>
      get copyWith =>
          _ProcreateV5SwatchCopyWithImpl<ProcreateV5Swatch, ProcreateV5Swatch>(
              this as ProcreateV5Swatch, $identity, $identity);
  @override
  String toString() {
    return ProcreateV5SwatchMapper.ensureInitialized()
        .stringifyValue(this as ProcreateV5Swatch);
  }

  @override
  bool operator ==(Object other) {
    return ProcreateV5SwatchMapper.ensureInitialized()
        .equalsValue(this as ProcreateV5Swatch, other);
  }

  @override
  int get hashCode {
    return ProcreateV5SwatchMapper.ensureInitialized()
        .hashValue(this as ProcreateV5Swatch);
  }
}
...
extension ProcreateV5SwatchValueCopy<$R, $Out>
  ...
  ProcreateV5SwatchCopyWith<$R, ProcreateV5Swatch, $Out>
      get $asProcreateV5Swatch => $base
          .as((v, t, t2) => _ProcreateV5SwatchCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ProcreateV5SwatchCopyWith<$R, $In extends ProcreateV5Swatch,
...
class _ProcreateV5SwatchCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, double, ObjectCopyWith<$R, double, double>> get components =>
      ListCopyWith($value.components, (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(components: v));
  @override
  $R call(
          {double? alpha,
...
class ProcreateV5ColorProfileMapper
  ...
  static ProcreateV5ColorProfileMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = ProcreateV5ColorProfileMapper._());
    }
    return _instance!;
  }
  ...
  static const Field<ProcreateV5ColorProfile, int> _f$colorSpace =
      Field('colorSpace', _$colorSpace);
  static String _$hash(ProcreateV5ColorProfile v) => v.hash;
  static const Field<ProcreateV5ColorProfile, String> _f$hash =
      Field('hash', _$hash);
  static String _$iccData(ProcreateV5ColorProfile v) => v.iccData;
  static const Field<ProcreateV5ColorProfile, String> _f$iccData =
      Field('iccData', _$iccData);
  static String _$iccName(ProcreateV5ColorProfile v) => v.iccName;
  static const Field<ProcreateV5ColorProfile, String> _f$iccName =
      Field('iccName', _$iccName);
...
mixin ProcreateV5ColorProfileMappable {
  ...
  ProcreateV5ColorProfileCopyWith<ProcreateV5ColorProfile,
          ProcreateV5ColorProfile, ProcreateV5ColorProfile>
  ...
  String toString() {
    return ProcreateV5ColorProfileMapper.ensureInitialized()
        .stringifyValue(this as ProcreateV5ColorProfile);
  }

  @override
  bool operator ==(Object other) {
    return ProcreateV5ColorProfileMapper.ensureInitialized()
        .equalsValue(this as ProcreateV5ColorProfile, other);
  }

  @override
  int get hashCode {
    return ProcreateV5ColorProfileMapper.ensureInitialized()
        .hashValue(this as ProcreateV5ColorProfile);
  }
}
...
extension ProcreateV5ColorProfileValueCopy<$R, $Out>
  ...
  ProcreateV5ColorProfileCopyWith<$R, ProcreateV5ColorProfile, $Out>
      get $asProcreateV5ColorProfile => $base.as((v, t, t2) =>
          _ProcreateV5ColorProfileCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class ProcreateV5PaletteMapper extends ClassMapperBase<ProcreateV5Palette> {
  ...
  static const Field<ProcreateV5Palette, String> _f$name =
      Field('name', _$name);
...
mixin ProcreateV5PaletteMappable {
  ...
  ProcreateV5PaletteCopyWith<ProcreateV5Palette, ProcreateV5Palette,
          ProcreateV5Palette>
      get copyWith => _ProcreateV5PaletteCopyWithImpl<ProcreateV5Palette,
          ProcreateV5Palette>(this as ProcreateV5Palette, $identity, $identity);
  @override
  String toString() {
    return ProcreateV5PaletteMapper.ensureInitialized()
        .stringifyValue(this as ProcreateV5Palette);
  }

  @override
  bool operator ==(Object other) {
    return ProcreateV5PaletteMapper.ensureInitialized()
        .equalsValue(this as ProcreateV5Palette, other);
  }

  @override
  int get hashCode {
    return ProcreateV5PaletteMapper.ensureInitialized()
        .hashValue(this as ProcreateV5Palette);
  }
}
...
abstract class ProcreateV5PaletteCopyWith<$R, $In extends ProcreateV5Palette,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, ProcreateV5Swatch?,
          ProcreateV5SwatchCopyWith<$R, ProcreateV5Swatch, ProcreateV5Swatch>?>
      get swatches;
  ListCopyWith<
      $R,
      ProcreateV5ColorProfile,
      ProcreateV5ColorProfileCopyWith<$R, ProcreateV5ColorProfile,
          ProcreateV5ColorProfile>> get colorProfiles;
  $R call(
      {String? name,
...
class _ProcreateV5PaletteCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
      ...
      ProcreateV5ColorProfile,
      ProcreateV5ColorProfileCopyWith<$R, ProcreateV5ColorProfile,
          ProcreateV5ColorProfile>> get colorProfiles => ListCopyWith(
      $value.colorProfiles,
