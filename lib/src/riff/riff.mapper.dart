...
class ResourceInterchangeFileFormatColorMapper
  ...
  static ResourceInterchangeFileFormatColorMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = ResourceInterchangeFileFormatColorMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<ResourceInterchangeFileFormatColor, int> _f$red = Field(
    'red',
    _$red,
  );
  static int _$green(ResourceInterchangeFileFormatColor v) => v.green;
  static const Field<ResourceInterchangeFileFormatColor, int> _f$green = Field(
    'green',
    _$green,
  );
  static int _$blue(ResourceInterchangeFileFormatColor v) => v.blue;
  static const Field<ResourceInterchangeFileFormatColor, int> _f$blue = Field(
    'blue',
    _$blue,
  );
  ...
  static ResourceInterchangeFileFormatColor fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<ResourceInterchangeFileFormatColor>(
      map,
    );
  }

  static ResourceInterchangeFileFormatColor fromJson(String json) {
    return ensureInitialized().decodeJson<ResourceInterchangeFileFormatColor>(
      json,
    );
  }
}
...
extension ResourceInterchangeFileFormatColorValueCopy<$R, $Out>
  ...
  ResourceInterchangeFileFormatColorCopyWith<
    ...
    $Out
  >
  get $asResourceInterchangeFileFormatColor => $base.as(
    (v, t, t2) =>
...
class ResourceInterchangeFileFormatMapper
  ...
  static ResourceInterchangeFileFormatMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = ResourceInterchangeFileFormatMapper._(),
      );
      ResourceInterchangeFileFormatColorMapper.ensureInitialized();
    }
    return _instance!;
  ...
  static const Field<
    ...
    List<ResourceInterchangeFileFormatColor>
  >
...
mixin ResourceInterchangeFileFormatMappable {
  ...
  ResourceInterchangeFileFormatCopyWith<
    ResourceInterchangeFileFormat,
    ResourceInterchangeFileFormat,
    ResourceInterchangeFileFormat
  >
  ...
  @override
  bool operator ==(Object other) {
    return ResourceInterchangeFileFormatMapper.ensureInitialized().equalsValue(
      this as ResourceInterchangeFileFormat,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ResourceInterchangeFileFormatMapper.ensureInitialized().hashValue(
      this as ResourceInterchangeFileFormat,
    );
  }
}
