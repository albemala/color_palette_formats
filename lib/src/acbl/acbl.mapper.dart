...
class AdobeColorBookLegacyPrefixPostfixMapper
  ...
  static AdobeColorBookLegacyPrefixPostfixMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = AdobeColorBookLegacyPrefixPostfixMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<AdobeColorBookLegacyPrefixPostfix, String> _f$id = Field(
    'id',
    _$id,
    opt: true,
  );
  ...
  static AdobeColorBookLegacyPrefixPostfix fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<AdobeColorBookLegacyPrefixPostfix>(
      map,
    );
  }

  static AdobeColorBookLegacyPrefixPostfix fromJson(String json) {
    return ensureInitialized().decodeJson<AdobeColorBookLegacyPrefixPostfix>(
      json,
    );
  }
}
...
extension AdobeColorBookLegacyPrefixPostfixValueCopy<$R, $Out>
  ...
  AdobeColorBookLegacyPrefixPostfixCopyWith<
    ...
    $Out
  >
  get $asAdobeColorBookLegacyPrefixPostfix => $base.as(
    (v, t, t2) =>
...
class _AdobeColorBookLegacyPrefixPostfixCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? prefix, String? postfix, Object? id = $none}) => $apply(
    FieldCopyWithData({
...
class AdobeColorBookLegacyFormatMapper
  ...
  static AdobeColorBookLegacyFormatMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = AdobeColorBookLegacyFormatMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<AdobeColorBookLegacyFormat, String> _f$colorSpace = Field(
    'colorSpace',
    _$colorSpace,
  );
  static String _$encoding(AdobeColorBookLegacyFormat v) => v.encoding;
  static const Field<AdobeColorBookLegacyFormat, String> _f$encoding = Field(
    'encoding',
    _$encoding,
  );
  static int _$channels(AdobeColorBookLegacyFormat v) => v.channels;
  static const Field<AdobeColorBookLegacyFormat, int> _f$channels = Field(
    'channels',
    _$channels,
  );
  static String _$id(AdobeColorBookLegacyFormat v) => v.id;
  static const Field<AdobeColorBookLegacyFormat, String> _f$id = Field(
    'id',
    _$id,
  );
...
mixin AdobeColorBookLegacyFormatMappable {
  ...
  AdobeColorBookLegacyFormatCopyWith<
  ...
  @override
  String toString() {
    return AdobeColorBookLegacyFormatMapper.ensureInitialized().stringifyValue(
      this as AdobeColorBookLegacyFormat,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return AdobeColorBookLegacyFormatMapper.ensureInitialized().equalsValue(
      this as AdobeColorBookLegacyFormat,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AdobeColorBookLegacyFormatMapper.ensureInitialized().hashValue(
      this as AdobeColorBookLegacyFormat,
    );
  }
}
...
extension AdobeColorBookLegacyFormatValueCopy<$R, $Out>
  ...
  get $asAdobeColorBookLegacyFormat => $base.as(
    (v, t, t2) => _AdobeColorBookLegacyFormatCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class AdobeColorBookLegacyColorMapper
  ...
  static AdobeColorBookLegacyColorMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = AdobeColorBookLegacyColorMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<AdobeColorBookLegacyColor, String> _f$name = Field(
    'name',
    _$name,
  );
  static List<double> _$values(AdobeColorBookLegacyColor v) => v.values;
  static const Field<AdobeColorBookLegacyColor, List<double>> _f$values = Field(
    'values',
    _$values,
  );
...
mixin AdobeColorBookLegacyColorMappable {
  ...
  AdobeColorBookLegacyColorCopyWith<
  ...
  @override
  String toString() {
    return AdobeColorBookLegacyColorMapper.ensureInitialized().stringifyValue(
      this as AdobeColorBookLegacyColor,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return AdobeColorBookLegacyColorMapper.ensureInitialized().equalsValue(
      this as AdobeColorBookLegacyColor,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AdobeColorBookLegacyColorMapper.ensureInitialized().hashValue(
      this as AdobeColorBookLegacyColor,
    );
  }
}
...
extension AdobeColorBookLegacyColorValueCopy<$R, $Out>
  ...
  get $asAdobeColorBookLegacyColor => $base.as(
    (v, t, t2) => _AdobeColorBookLegacyColorCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _AdobeColorBookLegacyColorCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? name, List<double>? values}) => $apply(
    FieldCopyWithData({
...
class AdobeColorBookLegacyMapper extends ClassMapperBase<AdobeColorBookLegacy> {
  ...
  static const Field<AdobeColorBookLegacy, int> _f$version = Field(
    'version',
    _$version,
  );
  static int _$bookId(AdobeColorBookLegacy v) => v.bookId;
  static const Field<AdobeColorBookLegacy, int> _f$bookId = Field(
    'bookId',
    _$bookId,
  );
  ...
  static const Field<
    ...
    List<AdobeColorBookLegacyPrefixPostfix>
  >
  _f$prefixPostfixPairs = Field('prefixPostfixPairs', _$prefixPostfixPairs);
...
mixin AdobeColorBookLegacyMappable {
  ...
  @override
  String toString() {
    return AdobeColorBookLegacyMapper.ensureInitialized().stringifyValue(
      this as AdobeColorBookLegacy,
    );
  }

  @override
  bool operator ==(Object other) {
    return AdobeColorBookLegacyMapper.ensureInitialized().equalsValue(
      this as AdobeColorBookLegacy,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AdobeColorBookLegacyMapper.ensureInitialized().hashValue(
      this as AdobeColorBookLegacy,
    );
  }
}
...
class _AdobeColorBookLegacyCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
    ...
    >
  >
  get prefixPostfixPairs => ListCopyWith(
    $value.prefixPostfixPairs,
  ...
  AdobeColorBookLegacy $make(CopyWithData data) => AdobeColorBookLegacy(
    ...
    prefixPostfixPairs: data.get(
      #prefixPostfixPairs,
      or: $value.prefixPostfixPairs,
    ),
