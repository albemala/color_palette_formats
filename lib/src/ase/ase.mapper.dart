  ...
  static AdobeSwatchExchangeColorModelMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = AdobeSwatchExchangeColorModelMapper._(),
      );
    }
    return _instance!;
  }
...
class AdobeSwatchExchangeColorTypeMapper
  ...
  static AdobeSwatchExchangeColorTypeMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = AdobeSwatchExchangeColorTypeMapper._(),
      );
    }
    return _instance!;
  }
...
class AdobeSwatchExchangeColorMapper
  ...
  static AdobeSwatchExchangeColorMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = AdobeSwatchExchangeColorMapper._(),
      );
      AdobeSwatchExchangeColorModelMapper.ensureInitialized();
      AdobeSwatchExchangeColorTypeMapper.ensureInitialized();
    }
  ...
  static const Field<AdobeSwatchExchangeColor, String> _f$name = Field(
    'name',
    _$name,
  );
  ...
  static const Field<AdobeSwatchExchangeColor, List<double>> _f$values = Field(
    'values',
    _$values,
  );
  ...
  _f$type = Field(
    ...
    _$type,
    opt: true,
    def: AdobeSwatchExchangeColorType.global,
  );
...
mixin AdobeSwatchExchangeColorMappable {
  ...
  AdobeSwatchExchangeColorCopyWith<
  ...
  @override
  String toString() {
    return AdobeSwatchExchangeColorMapper.ensureInitialized().stringifyValue(
      this as AdobeSwatchExchangeColor,
    );
  }

  @override
  bool operator ==(Object other) {
    return AdobeSwatchExchangeColorMapper.ensureInitialized().equalsValue(
      this as AdobeSwatchExchangeColor,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AdobeSwatchExchangeColorMapper.ensureInitialized().hashValue(
      this as AdobeSwatchExchangeColor,
    );
  }
}
...
extension AdobeSwatchExchangeColorValueCopy<$R, $Out>
  ...
  get $asAdobeSwatchExchangeColor => $base.as(
    (v, t, t2) => _AdobeSwatchExchangeColorCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class AdobeSwatchExchangeMapper extends ClassMapperBase<AdobeSwatchExchange> {
  ...
  static const Field<AdobeSwatchExchange, List<dynamic>> _f$groups = Field(
    'groups',
    _$groups,
    opt: true,
    def: const [],
...
mixin AdobeSwatchExchangeMappable {
  ...
  @override
  String toString() {
    return AdobeSwatchExchangeMapper.ensureInitialized().stringifyValue(
      this as AdobeSwatchExchange,
    );
  }

  @override
  bool operator ==(Object other) {
    return AdobeSwatchExchangeMapper.ensureInitialized().equalsValue(
      this as AdobeSwatchExchange,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AdobeSwatchExchangeMapper.ensureInitialized().hashValue(
      this as AdobeSwatchExchange,
    );
  }
}
...
abstract class AdobeSwatchExchangeCopyWith<
  $R,
  $In extends AdobeSwatchExchange,
  $Out
>
    implements ClassCopyWith<$R, $In, $Out> {
