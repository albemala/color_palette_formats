...
mixin GimpPaletteColorMappable {
  ...
  get copyWith =>
      _GimpPaletteColorCopyWithImpl<GimpPaletteColor, GimpPaletteColor>(
        this as GimpPaletteColor,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return GimpPaletteColorMapper.ensureInitialized().stringifyValue(
      this as GimpPaletteColor,
    );
  }
  ...
  bool operator ==(Object other) {
    return GimpPaletteColorMapper.ensureInitialized().equalsValue(
      this as GimpPaletteColor,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return GimpPaletteColorMapper.ensureInitialized().hashValue(
      this as GimpPaletteColor,
    );
  }
}
...
extension GimpPaletteColorValueCopy<$R, $Out>
  ...
  get $asGimpPaletteColor =>
      $base.as((v, t, t2) => _GimpPaletteColorCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class GimpPaletteMapper extends ClassMapperBase<GimpPalette> {
  ...
  static const Field<GimpPalette, List<GimpPaletteColor>> _f$colors = Field(
    'colors',
    _$colors,
  );
  static List<String> _$info(GimpPalette v) => v.info;
  static const Field<GimpPalette, List<String>> _f$info = Field(
    'info',
    _$info,
    opt: true,
    def: const [],
  ...
  static const Field<GimpPalette, List<String>> _f$comments = Field(
    'comments',
    _$comments,
    opt: true,
    def: const [],
...
mixin GimpPaletteMappable {
  String toJson() {
    return GimpPaletteMapper.ensureInitialized().encodeJson<GimpPalette>(
      this as GimpPalette,
    );
  }

  Map<String, dynamic> toMap() {
    return GimpPaletteMapper.ensureInitialized().encodeMap<GimpPalette>(
      this as GimpPalette,
    );
  }
  ...
  @override
  String toString() {
    return GimpPaletteMapper.ensureInitialized().stringifyValue(
      this as GimpPalette,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return GimpPaletteMapper.ensureInitialized().equalsValue(
      this as GimpPalette,
      other,
    );
  }
