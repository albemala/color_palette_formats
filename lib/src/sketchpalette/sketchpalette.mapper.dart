...
class SketchPaletteColorMapper extends ClassMapperBase<SketchPaletteColor> {
  ...
  static const Field<SketchPaletteColor, double> _f$green = Field(
    'green',
    _$green,
  );
  static double _$blue(SketchPaletteColor v) => v.blue;
  static const Field<SketchPaletteColor, double> _f$blue = Field(
    'blue',
    _$blue,
  );
  static double _$alpha(SketchPaletteColor v) => v.alpha;
  static const Field<SketchPaletteColor, double> _f$alpha = Field(
    'alpha',
    _$alpha,
  );
...
mixin SketchPaletteColorMappable {
  ...
  SketchPaletteColorCopyWith<
    SketchPaletteColor,
    SketchPaletteColor,
    SketchPaletteColor
  >
  get copyWith =>
      _SketchPaletteColorCopyWithImpl<SketchPaletteColor, SketchPaletteColor>(
        this as SketchPaletteColor,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return SketchPaletteColorMapper.ensureInitialized().stringifyValue(
      this as SketchPaletteColor,
    );
  }
  ...
  bool operator ==(Object other) {
    return SketchPaletteColorMapper.ensureInitialized().equalsValue(
      this as SketchPaletteColor,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SketchPaletteColorMapper.ensureInitialized().hashValue(
      this as SketchPaletteColor,
    );
  }
}
...
abstract class SketchPaletteColorCopyWith<
  $R,
  $In extends SketchPaletteColor,
  $Out
>
...
class _SketchPaletteColorCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({double? red, double? green, double? blue, double? alpha}) => $apply(
    FieldCopyWithData({
      if (red != null) #red: red,
...
class SketchPaletteMapper extends ClassMapperBase<SketchPalette> {
  ...
  static const Field<SketchPalette, String> _f$compatibleVersion = Field(
    'compatibleVersion',
    _$compatibleVersion,
  );
  static String _$pluginVersion(SketchPalette v) => v.pluginVersion;
  static const Field<SketchPalette, String> _f$pluginVersion = Field(
    'pluginVersion',
    _$pluginVersion,
  );
  static List<SketchPaletteColor> _$colors(SketchPalette v) => v.colors;
  static const Field<SketchPalette, List<SketchPaletteColor>> _f$colors = Field(
    'colors',
    _$colors,
  );
...
mixin SketchPaletteMappable {
  String toJson() {
    return SketchPaletteMapper.ensureInitialized().encodeJson<SketchPalette>(
      this as SketchPalette,
    );
  }

  Map<String, dynamic> toMap() {
    return SketchPaletteMapper.ensureInitialized().encodeMap<SketchPalette>(
      this as SketchPalette,
    );
  }
  ...
  @override
  String toString() {
    return SketchPaletteMapper.ensureInitialized().stringifyValue(
      this as SketchPalette,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return SketchPaletteMapper.ensureInitialized().equalsValue(
      this as SketchPalette,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SketchPaletteMapper.ensureInitialized().hashValue(
      this as SketchPalette,
    );
  }
}
...
abstract class SketchPaletteCopyWith<$R, $In extends SketchPalette, $Out>
  ...
  ListCopyWith<
    $R,
    SketchPaletteColor,
    SketchPaletteColorCopyWith<$R, SketchPaletteColor, SketchPaletteColor>
  >
  get colors;
  $R call({
...
class _SketchPaletteCopyWithImpl<$R, $Out>
  ...
  SketchPalette $make(CopyWithData data) => SketchPalette(
    compatibleVersion: data.get(
      #compatibleVersion,
      or: $value.compatibleVersion,
    ),
