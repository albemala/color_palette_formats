...
Map<String, String> extractColors(Map<String, dynamic> map) {
  ...
  final nsComponentsValues = extractedMaps //
      .where((map) => map.containsKey('NSComponents'))
      .map((map) {
    final nsComponentsValue = map['NSComponents'];
    return nsComponentsValue is List<int>
        ? String.fromCharCodes(nsComponentsValue)
        : nsComponentsValue.toString();
  }).toList();
  print(nsComponentsValues);
